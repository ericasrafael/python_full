...
# cai no if apenas se arquivos não existirem
        ...
        if local == 1:
            ...
            while True:
                ...
                if decisao == 1:
                    ...
                    nova_endereco = input("Digite o novo endereco do cliente")
            ...
            while True:
                ...
                if decisao == 1:
                    ...
                    endereco = input(
                        "Digite a endereco do novo funcionario:\n")
                    ...
                    novo_contato = input(
                        "Digite o novo contato do funcionario:\n")
                    novo_cpf = input("Digite a novo CPF do funcionario:\n")
                    novo_email = input(
                        "Digite o novo e-mail do funcionario:\n")
                    nova_endereco = input(
                        "Digite o novo endereco do funcionario: ")
                    func.alterar(alterar_funcionario, novo_funcionario, novo_clt,
                                 novo_contato, novo_cpf, novo_email, nova_endereco)
                elif decisao == 4:
                    func.visualizar()
                else:
            ...
            while True:
                ...
                if decisao == 1:
                    ...
                    dataInicio = input(
                        "Digite a data de inicio no formato dia/mes/ano: \n")
                    dataTermino = input(
                        "Digite a data de termino no formato dia/mes/ano: \n")
